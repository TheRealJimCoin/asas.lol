          ...
          <form onSubmit={handleSubmit(onRegistered)} noValidate>
                ...
                {isDisallowedNFT ? (
                    ...
                    {assetName != '' && assetImage != '' && assetImage != null  && assetCreator != '' ? (
                        ...
                        {assetMimeType === 'video/mp4' || assetMimeType === 'video/3gpp' || assetMimeType === 'video/quicktime' ? (
                            <>
                            <Center p={2}>
                            <video className={'reactvidplayercreate'} autoPlay={false} src={assetImage != '' ? BUYITNOW.resolveUrl(assetImage) : 'placeholder.png'} controls>
                                <source src={assetImage != '' ? BUYITNOW.resolveUrl(assetImage) : 'placeholder.png'} type="video/mp4" />
                            </video>
                            </Center>
                            </>
                        ) : (
                            <>
                            <Center p={2}>
                                <Image boxSize='150px' objectFit='cover' borderRadius='lg' alt='ASAs.lol NFT Auctions' src={assetImage != '' ? BUYITNOW.resolveUrl(assetImage) : 'placeholder.png'} />
                            </Center>
                            </>
                        )}
            ...
            <Box p={2}>
                    <FormControl isRequired isInvalid={errors.ticketcost}>
                        ...
                        Buy It Now Price (In <>{currency.unitname}</>)
                        </FormLabel>
                        <Input
                        id="ticketcost"
                        size="sm"
                        ...
                        placeholder="0"
                        {...register("ticketcost", {
                            required: "Please enter the buy it now price of the listing?",
                            min: {
                                value: 1,
                                message: "Buy it now Price must be atleast 1"
                            },
                        })}
                        ></Input>
